...
*/
    ...
    FastBasisConversionInModUp<<<128, 128>>>( 
                                a,
                                ra,
                                index,
                                degree, log_degree,
    ...
    //for (int i=0;i<alpha;i++)
    //{
        pNTTFront<<<256*alpha/4,128>>>(ra+((level+1)<<log_degree), 
                                log_degree,
                                alpha,
                                0, degree,
                                pVec, pInvVec,
        ...
        */
        //printf("here!\n");
    //}    
        pNTTBack<<<32*alpha/4,1024>>>(ra+((level+1)<<log_degree), 
                                log_blockDim,
                                alpha,
                                0, degree,
                                pVec, pInvVec,
                        ...
                        )
{
    ...
    //for (int i=0; i<alpha; i++)
    //{
        piNTTFront<<<256*alpha/4,128>>>(a+((level+1)<<log_degree), 
                                log_degree,
                                alpha,
                                0, degree,
                                pVec, pInvVec,
    ...
    //}
        //printf("here!\n");
        piNTTBack<<<32*alpha/4,1024>>>(a+((level+1)<<log_degree), 
                                log_blockDim,
                                alpha,
                                0, degree,
                                pVec, pInvVec,
    ...
    FastBasisConversionInModDown<<<128, 128>>>(   
                                    a,
                                    ra,
                                    degree, log_degree,
                                    alpha, beta, level, alpha,
...
//        qHatModp[i]=(word64**)malloc(sizeof(word64*) * (alpha_));
    ...
    gpu_tensor_product<<<256/4, 256>>> ( gc1_a, gc1_b, gc2_a, gc2_b, 
